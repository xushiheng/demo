...
public class MainActivity extends Activity {
	...
	private ArrayList<String> getAry() {
		...
		Cursor cursor = null;
		cursor = contentResolver.query(Word.CONTACTS_URI,new String[]{Word.KEY_ID,Word.KEY_NAME}, null, null, null);
	...
	private List<Map<String, String>> getContact(Cursor cur) {
		...
		if (cur.getCount() == 0) {
			...
			while (cur.moveToNext()) {
				...
				item.put(Word.KEY_MOBILE, cur.getString(cur.getColumnIndex(Word.KEY_MOBILE)));
				data.add(item);
			}
		}
		return data;
